...
| 하이패스 영수증 발급 | 로그인된 브라우저 세션에서만 하이패스 사용내역 조회와 영수증 선택 출력 payload 준비를 보조 | 필요 | [하이패스 영수증 발급 가이드](docs/features/hipass-receipt.md) |
...
| 번개장터 검색 | upstream [`bunjang-cli`](https://www.npmjs.com/package/bunjang-cli) 기반으로 번개장터 검색, 상세조회, 선택적 찜/채팅, 대량 수집, AI TOON export 안내 | 불필요 | [번개장터 검색 가이드](docs/features/bunjang-search.md) |
