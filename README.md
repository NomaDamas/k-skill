...
| 커리어넷 진로·직업정보 조회 | `careernet-career-info` | 커리어넷 공식 API로 직업 검색과 직업 설명·흥미·관련 진로 정보 조회(프록시 경유) | 불필요 | [커리어넷 진로·직업정보 조회 가이드](docs/features/careernet-career-info.md) |
...
- [커리어넷 진로·직업정보 조회 가이드](docs/features/careernet-career-info.md)
