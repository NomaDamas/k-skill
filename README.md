...
| 장학금 찾기 lets go | 한국장학재단·전국 대학교·재단·기업 장학 공고를 검색해 금액·자격·지원구간·링크를 정리하고 현재 날짜 기준 마감 상태와 조건별 필터링까지 제공 | 불필요 | [장학금 찾기 lets go 가이드](docs/features/korean-scholarship-search.md) |
...
- [장학금 찾기 lets go 가이드](docs/features/korean-scholarship-search.md)
