...
| 수입화물 통관 진행 조회 | `customs-cargo-clearance` | 관세청 UNI-PASS 공식 API로 화물관리번호·B/L 기준 통관 상태와 이벤트 조회(프록시 경유) | 불필요 | [수입화물 통관 진행 조회 가이드](docs/features/customs-cargo-clearance.md) |
...
- [수입화물 통관 진행 조회 가이드](docs/features/customs-cargo-clearance.md)
