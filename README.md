...
| 국가자격 시험 일정 조회 | `hrdkorea-qualification-search` | 한국산업인력공단 공식 API로 국가자격 시험 일정·종목 정보 조회(프록시 경유) | 불필요 | [국가자격 시험 일정 조회 가이드](docs/features/hrdkorea-qualification-search.md) |
...
- [국가자격 시험 일정 조회 가이드](docs/features/hrdkorea-qualification-search.md)
