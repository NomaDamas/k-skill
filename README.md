...
| 교통사고 다발지역·통계 조회 | `traffic-accident-risk-search` | 한국도로교통공단 TAAS 공식 API로 연도·지역별 사고 다발지역과 통계를 조회(프록시 경유) | 불필요 | [교통사고 다발지역·통계 조회 가이드](docs/features/traffic-accident-risk-search.md) |
...
- [교통사고 다발지역·통계 조회 가이드](docs/features/traffic-accident-risk-search.md)
