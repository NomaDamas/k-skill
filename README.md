...
| HTML 발표자료 생성 | `html-presentation` | 슬라이드 콘텐츠만 작성하면 키보드 네비·사이드 네비·풀스크린 no-scroll이 보장되는 단일 HTML 발표자료 생성 (PPT 대체) | 불필요 | [HTML 발표자료 생성 가이드](docs/features/html-presentation.md) |
