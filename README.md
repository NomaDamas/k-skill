...
| 학교 학사일정 조회 | `k-school-calendar` | 교육청·학교명으로 NEIS 학교 검색·학사일정 조회 | 불필요 | [학교 학사일정 조회 가이드](docs/features/k-school-calendar.md) |
...
- [학교 학사일정 조회 가이드](docs/features/k-school-calendar.md)
