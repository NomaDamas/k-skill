...
| 서울 따릉이 실시간 대여소 | `seoul-bike-share` | 서울 공공자전거(따릉이) 실시간 대여소·잔여 자전거·반납 가능 거치대 조회 | 불필요 | [서울 따릉이 가이드](docs/features/seoul-bike-share.md) |
...
- [서울 따릉이 실시간 대여소 조회](docs/features/seoul-bike-share.md)
