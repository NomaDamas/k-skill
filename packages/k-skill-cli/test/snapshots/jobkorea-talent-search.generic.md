# jobkorea-talent-search — assembled instructions
...
- Prepare the recipient, draft, and official surface link that the documented portable workflow supports, then hand the final send action to the user. Do not automate delivery here.
