# 상표 사용 법적 고지 — `sharenuri-facility-search`

이 스킬에서 `공유누리` 명칭은 행정안전부 공공개방자원 포털의 공공시설·공공개방자원 정보 조회의 **대상 공식 서비스**를 식별하기 위해 사용한다. k-skill의 출처나 운영주체를 해당 서비스 운영기관으로 표시하려는 사용이 아니다.
